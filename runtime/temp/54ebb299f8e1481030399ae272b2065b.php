<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\duobao_hk/application/admin\view\menus\list.html";i:1508732348;s:74:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\duobao_hk/application/admin\view\base.html";i:1508807744;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<div id='privilegeBox' style='display:none'>
  ...
  <table class='wst-form wst-box-top'>
     ...
     <tr>
        ...
        <td><input type='text' id='privilegeCode' class='ipt' maxLength='10' onblur='javascript:checkPrivilegeCode(this)' data-rule="权限代码: required;"/></td>
     </tr>
     <tr>
