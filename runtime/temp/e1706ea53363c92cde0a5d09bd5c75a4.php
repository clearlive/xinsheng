<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\duobao_hk/application/admin\view\login.html";i:1542288834;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="wst-lo-center">
	<div class="wst-lo">
		<div class="wst-lo-left"><img src='__ADMIN__/img/left1.png' height='300'/></div>
	</div>
	<div class="wst-lo">
	...
	<table>
	  <tr>
	    <td><div class="frame">
	    	...
	    	<input type='text' id='loginName' class='ipt text' value='' placeholder="账号" >
	    </div></td>
	  </tr>
	  <tr>
	    <td><div class="frame">
		    <span class="loginpwd"></span>
		    <input type='password' id='loginPwd' class='ipt text' placeholder="密码" >
	    </div></td>
	  </tr>
	  <tr>
