<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\duobao_hk/application/admin\view\messages\list.html";i:1511747764;s:74:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\duobao_hk/application/admin\view\base.html";i:1508807744;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
    ...
    <table class='wst-form wst-box-top'>
      ...
      <th width='150'>发送类型<font color='red'>*</font>：</th>
          <td style="text-align:left;">
            ...
            <label><input type="radio" name="sendType" id="sendType" value="shop" class='ipt'  onchange="sendToTheUser()" checked>平台</label>
