<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\duobao_hk/application/admin\view\index.html";i:1512551158;s:74:"C:\UPUPW_ANK_W64\WebRoot\Vhosts\duobao_hk/application/admin\view\base.html";i:1508807744;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
.l-accordion-content{height: auto !important;}
</style>
...
<div class="wst-topmenu-welcome">
    <a href="<?php echo url('home/index/index'); ?>" target='_blank' class="wst-top-link">网站首页</a>
...
<div id='check_cash' style='display:none;padding-top:5px;'>
  <form id='check_cashFrom' autocomplete="off">
   <table class='wst-form'>
      <tr>
         <th style='width:100px'>原密码：</th>
         <td><input type='password' id='srcPass' name='srcPass' class='ipt' data-rule="原密码: required;" maxLength='16'/></td>
