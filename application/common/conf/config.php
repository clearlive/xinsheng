...
// +----------------------------------------------------------------------
define('USERTYPE1', '101');
define('USERTYPE2', '102');
define('USERTYPE3', '103');
define('USERTYPE4', '104');
define('USERTYPE1NAME', '运营中心');
define('USERTYPE2NAME', '会员单位');
define('USERTYPE3NAME', '代理商');
define('USERTYPE4NAME', '客户');
