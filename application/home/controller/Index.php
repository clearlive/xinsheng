...
class Index extends Base{
    ...
    **/
    ...
    public function ajax_kaijiang()
    {
        ...
        foreach ($ssc_list as $key => $vo) {
            $time = date('Y-m-d H:i:s',$vo['createtime']);
            $html .='<div class="kjj">
            <p  class="kjjpq">20'.$vo['issue'].'<span>期</span> <span style="float:right;margin-right:2rem">'.$time.'</span></p>
                <div class="k_1">
                    
                    <blockquote>
                        <span  style="color: #989898;">'.substr($vo['balls'],0,1).'</span>
                        <span  style="color: #989898;">'.substr($vo['balls'],1,1).'</span>
                        <span  style="color: #989898;">'.substr($vo['balls'],2,1).'</span>
   ...
   public function index_order($page=1)
   {
		...
		*/
        ...
        foreach ($list as $k => $v){
            $html .= '<li><dl><a href="javascript:void();">
                            <dt><img src="'.getuser_photo($v['userPhoto']).'"></dt>
                                ...
                                </a><p style="color:#999;"><a href="javascript:void();">
       ...
       $where['iswin'] = 1;
        ...
        foreach ($list as $k => $v){
            $html .= '<li><a href="javascript:void(0);">
                        </a><dl><a href="javascript:void(0);">
                            <dt><img src="'.getuser_photo($v['userPhoto']).'"></dt>
                            </a><dd><a href="javascript:void(0);">
                                <p><span>'.substr($v['userPhone'], 0,3).'****'.substr($v['userPhone'], -4).'</span></p>
                                </a><p style="color:#999;"><a href="javascript:void(0);">
